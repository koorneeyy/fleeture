...
public class Util {
    ...
    public static boolean isGenreIdCorrect(int genre) {
        return genre >= 0 && genre < 80;
    }

    public static int getGenreByValue(String strName) {
        if (!GENRES.containsValue(strName)) return -1;
